...
val appModule = module {
    single<AppConfig> { AppConfigImpl(get<ApplicationEnvironment>()).config }
...
fun Application.configureDI() {
    ...
    // Register the ApplicationEnvironment for Koin
    org.koin.core.context.GlobalContext.get().get<org.koin.core.scope.Scope>().declare(environment)
}
