...
mixin _$TaskUpdateRequestDto {
 ...
 String? get title; String? get description; TaskStatus? get status; Priority? get priority; DateTime? get dueDate; String? get projectId; String? get assigneeId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,description,status,priority,dueDate,projectId,assigneeId);
...
@useResult
$Res call({
 String? title, String? description, TaskStatus? status, Priority? priority, DateTime? dueDate, String? projectId, String? assigneeId
});
...
/// Create a copy of TaskUpdateRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = freezed,Object? description = freezed,Object? status = freezed,Object? priority = freezed,Object? dueDate = freezed,Object? projectId = freezed,Object? assigneeId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? title,  String? description,  TaskStatus? status,  Priority? priority,  DateTime? dueDate,  String? projectId,  String? assigneeId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskUpdateRequestDto() when $default != null:
return $default(_that.title,_that.description,_that.status,_that.priority,_that.dueDate,_that.projectId,_that.assigneeId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? title,  String? description,  TaskStatus? status,  Priority? priority,  DateTime? dueDate,  String? projectId,  String? assigneeId)  $default,) {final _that = this;
switch (_that) {
case _TaskUpdateRequestDto():
return $default(_that.title,_that.description,_that.status,_that.priority,_that.dueDate,_that.projectId,_that.assigneeId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? title,  String? description,  TaskStatus? status,  Priority? priority,  DateTime? dueDate,  String? projectId,  String? assigneeId)?  $default,) {final _that = this;
switch (_that) {
case _TaskUpdateRequestDto() when $default != null:
return $default(_that.title,_that.description,_that.status,_that.priority,_that.dueDate,_that.projectId,_that.assigneeId);case _:
  return null;
...
class _TaskUpdateRequestDto implements TaskUpdateRequestDto {
  const _TaskUpdateRequestDto({this.title, this.description, this.status, this.priority, this.dueDate, this.projectId, this.assigneeId});
...
/// Create a copy of TaskUpdateRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = freezed,Object? description = freezed,Object? status = freezed,Object? priority = freezed,Object? dueDate = freezed,Object? projectId = freezed,Object? assigneeId = freezed,}) {
