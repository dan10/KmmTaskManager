...
mixin _$LoginResponseDto {
 ...
 String get token; UserPublicResponseDto get user;
...
@useResult
$Res call({
 String token, UserPublicResponseDto user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String token,  UserPublicResponseDto user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String token,  UserPublicResponseDto user)  $default,) {final _that = this;
switch (_that) {
case _LoginResponseDto():
return $default(_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String token,  UserPublicResponseDto user)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponseDto() when $default != null:
return $default(_that.token,_that.user);case _:
  return null;
...
@override final  UserPublicResponseDto user;
...
@override $UserPublicResponseDtoCopyWith<$Res> get user;
