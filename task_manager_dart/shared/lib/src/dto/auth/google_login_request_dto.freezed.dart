...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoogleLoginRequestDto&&(identical(other.idToken, idToken) || other.idToken == idToken));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GoogleLoginRequestDto&&(identical(other.idToken, idToken) || other.idToken == idToken));
}
