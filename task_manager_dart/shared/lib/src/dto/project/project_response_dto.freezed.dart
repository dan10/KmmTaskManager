...
$ProjectResponseDtoCopyWith<ProjectResponseDto> get copyWith => _$ProjectResponseDtoCopyWithImpl<ProjectResponseDto>(this as ProjectResponseDto, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectResponseDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.completed, completed) || other.completed == completed)&&(identical(other.inProgress, inProgress) || other.inProgress == inProgress)&&(identical(other.total, total) || other.total == total)&&(identical(other.creatorId, creatorId) || other.creatorId == creatorId)&&const DeepCollectionEquality().equals(other.memberIds, memberIds)&&(identical(other.creator, creator) || other.creator == creator)&&const DeepCollectionEquality().equals(other.members, members)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,completed,inProgress,total,creatorId,const DeepCollectionEquality().hash(memberIds),creator,const DeepCollectionEquality().hash(members),createdAt,updatedAt);
...
/// Create a copy of ProjectResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? completed = null,Object? inProgress = null,Object? total = null,Object? creatorId = freezed,Object? memberIds = null,Object? creator = freezed,Object? members = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as User?,members: null == members ? _self.members : members // ignore: cast_nullable_to_non_nullable
as List<User>,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ProjectResponseDto].
extension ProjectResponseDtoPatterns on ProjectResponseDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ProjectResponseDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ProjectResponseDto value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ProjectResponseDto value)?  $default,){
final _that = this;
switch (_that) {
case _ProjectResponseDto() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$ProjectResponseDtoCopyWith<_ProjectResponseDto> get copyWith => __$ProjectResponseDtoCopyWithImpl<_ProjectResponseDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ProjectResponseDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectResponseDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.completed, completed) || other.completed == completed)&&(identical(other.inProgress, inProgress) || other.inProgress == inProgress)&&(identical(other.total, total) || other.total == total)&&(identical(other.creatorId, creatorId) || other.creatorId == creatorId)&&const DeepCollectionEquality().equals(other._memberIds, _memberIds)&&(identical(other.creator, creator) || other.creator == creator)&&const DeepCollectionEquality().equals(other._members, _members)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,completed,inProgress,total,creatorId,const DeepCollectionEquality().hash(_memberIds),creator,const DeepCollectionEquality().hash(_members),createdAt,updatedAt);
...
/// @nodoc
abstract mixin class _$ProjectResponseDtoCopyWith<$Res> implements $ProjectResponseDtoCopyWith<$Res> {
...
as List<String>,creator: freezed == creator ? _self.creator : creator // ignore: cast_nullable_to_non_nullable
as User?,members: null == members ? _self._members : members // ignore: cast_nullable_to_non_nullable
as List<User>,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
