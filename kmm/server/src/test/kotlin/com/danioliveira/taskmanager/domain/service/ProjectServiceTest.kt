...
//
//        // Update the project
//        val updated = projectService.updateProjectWithPermission(project.id.toString(), ownerId, updateRequest)
//
//        // Verify the update was successful
//        assertTrue(updated)
//
//        // Get the project to verify the changes
//        val updatedProject = projectService.getProjectById(project.id, ownerId)
...
//
//        // Delete the project
//        val deleted = projectService.deleteProjectWithPermission(project.id, ownerId)
//
...
//        try {
//            projectService.getProjectById(project.id, ownerId)
//            fail("Expected NotFoundException was not thrown")
//        } catch (e: NotFoundException) {
//            // Expected exception
//            assertTrue(e.message.contains("Project"))
...
//        assertTrue(projectService.isUserAssignedToProject(project.id.toString(), userId.toString()))
//    }
//
//    @Test
...
//        assertFalse(projectService.isUserAssignedToProject(project.id.toString(), userId.toString()))
//    }
//
//    @Test
...
//        val users = projectService.getUsersByProject(project.id.toString())
//
...
//        assertTrue(projects.contains(project1.id.toString()))
//        assertTrue(projects.contains(project2.id.toString()))
//    }
//
//    @Test
...
//        val isAssigned = projectService.isUserAssignedToProject(project.id.toString(), userId.toString())
//
...
//        val otherIsAssigned = projectService.isUserAssignedToProject(project.id.toString(), otherUserId.toString())
//
