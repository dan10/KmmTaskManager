...
class TaskCreateEditViewModel(
    ...
    private val _events = MutableSharedFlow<TaskCreateEditEvent>()
    val events: SharedFlow<TaskCreateEditEvent> = _events.asSharedFlow()
        ...
        viewModelScope.launch {
            ...
            result.fold(
                ...
                onFailure = { error ->
                    ...
                    _events.emit(
                        TaskCreateEditEvent.ShowSnackbar(
    ...
    sealed class TaskCreateEditEvent {
